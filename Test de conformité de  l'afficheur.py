...
def main():
    ...
    chemin_modele_cnn = r'C:\Users\INFOKOM\Desktop\opencv_project\afficheur_cnn.h5'
    
    # Chemin vers l'image à tester
    chemin_image = r'C:\Users\INFOKOM\Desktop\Test_par_vision\test_afficheur_teststand\R LCD_2023-05-05 05.04.14,239.jpg'
